...
export function StoreDetailPanel({ store, onClose }: StoreDetailPanelProps) {
  ...
  return (
    <aside
      ...
      className="absolute top-4 left-4 bottom-4 z-20 w-[420px] max-w-[calc(100%-32px)] overflow-y-auto rounded-md border-[1.5px] border-[#d8c79d] bg-[#fffdf8] shadow-[0_10px_30px_rgba(20,20,20,.22)]"
    >
