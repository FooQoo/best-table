  ...
  return [
    {
      ...
      answer: `店舗紹介文と口コミからは、${room}で接客評価も${service}となっており、接待に使いやすい候補です。${concernNote}最終判断は最新の口コミもあわせてご確認ください。`,
    },
    {
    ...
    },
    {
      ...
      answer: `格式感の評価は「${prestige}」です。写真・口コミの範囲では役員クラスの会食にも対応しやすい雰囲気ですが、当日の空席状況までは保証できません。`,
    },
    {
      question: "初対面の取引先には堅すぎませんか？",
      answer: `${genre}で、口コミ上の雰囲気は${store.prestige === "◎" ? "やや格式高め" : "程よい落ち着き"}です。初対面の相手との距離感が気になる場合は、事前に個室の可否を確認すると安心です。`,
    },
  ];
}
