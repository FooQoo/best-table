...
export const STORES: Store[] = [
  { id: "s1", placeId: null, name: "日本料理 花明かり", genre: "japanese", area: "銀座", address: null, location: null, phone: "03-1234-5601", photoUrl: null, matchTier: "highest", room: "個室あり", quiet: "◎", prestige: "◎", service: "◎", access: "銀座駅 徒歩3分", budgetLabel: "¥30,000", concerns: [], matchingSummary: "完全個室と口コミ評価の高さが揃っており、重要顧客との会食でも格式面の不安が少ない。写真からも落ち着いた内装がうかがえる。", evidence: ["review", "photo", "description"], confidence: "high", generatedAt: "2026-07-04T09:00:00.000Z", photoPlaceholderLabel: "個室 写真", pos: { top: "20%", left: "32%" } },
  ...
  { id: "s4", placeId: null, name: "京料理 和心", genre: "japanese", area: "丸の内", address: null, location: null, phone: "03-1234-5604", photoUrl: null, matchTier: "highest", room: "個室あり", quiet: "◎", prestige: "◎", service: "○", access: "東京駅 徒歩4分", budgetLabel: "¥30,000", concerns: [], matchingSummary: "個室ありで静かさ・格式感の評価も高く、役員クラスの会食に適した候補。接客面の口コミはやや分かれており、当日の混雑状況によって差が出る可能性がある。", evidence: ["review", "photo"], confidence: "high", generatedAt: "2026-07-04T09:00:00.000Z", photoPlaceholderLabel: "個室 写真", pos: { top: "28%", left: "76%" } },
