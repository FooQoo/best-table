...
- `docs/AI.md`: AI SDK 実装ルール、モデル選定、ユースケース別プロンプト構築、エラーハンドリング（AI処理の一次情報源）
- `docs/ARCHITECTURE.md`: React Router 構成、app 配下のコード配置、状態モデル、Client/Server 境界、店舗データモデル、地図実装
- `docs/RELIABILITY.md`: 段階的表示、データ鮮度、想定される失敗、信頼性の受け入れ条件
